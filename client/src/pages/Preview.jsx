        ...
        <div className="flex flex-col min-h-screen bg-slate-50">
            <div className="flex-grow grid grid-cols-1 lg:grid-cols-2 mt-10 gap-12 px-6 max-w-7xl mx-auto items-center">
                ...
                <div className="order-1 lg:order-2 relative h-[400px] sm:h-[500px] flex items-center justify-center">
                    <img src={desktopPreview} alt="Desktop Dashboard" className="absolute top-10 right-0 w-[85%] rounded-xl shadow-2xl border border-slate-200 z-0"/>
                    <div className="absolute bottom-0 left-4 w-[160px] sm:w-[200px] z-10">
                        <div className="relative border-gray-900 bg-gray-900 border-[8px] rounded-[2rem] shadow-2xl">
                            <div className="h-[32px] w-[3px] bg-gray-800 absolute -start-[10px] top-[40px] rounded-s-lg"></div>
                            <div className="h-[46px] w-[3px] bg-gray-800 absolute -start-[10px] top-[80px] rounded-s-lg"></div>
            ...
            <footer className="bg-slate-900 text-slate-400 py-8 mt-auto font-mono">
                <div className="max-w-5xl mx-auto text-center space-y-3">
                    ...
                    <div className="flex justify-center gap-6 text-sm mt-4">
                        <a href="https://github.com/Gurpreet-05" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
                        ...
                        <a href="https://www.linkedin.com/in/gurpreet-singh-096a7b286" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
